...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-primary-bg">
      ...
      {/* Categories */}
      <section id="categories" className="py-20 px-8 my-10 max-w-7xl mx-auto bg-[#F6F6F4] rounded-[40px] border border-black/5 shadow-sm">
      ...
      {/* Process */}
      <section id="process" className="py-20 px-8 my-10 max-w-7xl mx-auto bg-[#F6F6F4] rounded-[40px] border border-black/5 shadow-sm">
