...
export const ContactForm = () => (
  <section id="contact" className="py-16 px-12 my-16 max-w-4xl mx-auto bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#EFEFEF] to-[#E8E8E8] rounded-[30px] border border-black/5 shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),0_20px_50px_rgba(0,0,0,0.08)]">
