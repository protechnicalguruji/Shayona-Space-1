...
export const Navbar = () => (
  <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-6 bg-transparent">
    <div className="text-2xl font-serif font-bold text-text-main">Shayona Space</div>
...
export const PropertyCard = ({ image, title, location, price }: { image: string, title: string, location: string, price: string }) => (
  <motion.div
    whileHover={{ y: -10 }}
  ...
  >
    ...
    <div className="p-6">
      ...
      <button className="flex items-center text-sm font-semibold hover:text-accent transition-colors">
