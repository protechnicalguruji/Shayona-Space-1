...
export const ContactForm = () => (
  <section id="contact" className="py-16 px-12 my-16 max-w-4xl mx-auto bg-gradient-to-br from-[#f2f2f2] to-[#e5e5e5] rounded-[30px] border border-black/5 shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
